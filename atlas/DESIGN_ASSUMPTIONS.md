...
12. **Route onboarding** — top-center “New features” card with one section per feature (drag-to-edit, undo/reset, route options, road rules, stops, save/start). Persisted via `atlas.onboarding.v1` after Got it.
